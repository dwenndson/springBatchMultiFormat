...
import com.udemy.primeiroprojetospringbatch.dominio.Transacao;
...
public class ClienteTransacaoLineMapperConfig {
    ...
    private Map<String, FieldSetMapper> fieldSetMappers() {
        ...
        fieldSetMappers.put("1*", fieldSetMapper(Cliente.class));
        fieldSetMappers.put("0*", fieldSetMapper(Transacao.class));
    ...
    private Map<String, LineTokenizer> tokenizers() {
        ...
        tokenizers.put("1*", clienteLineTokenizer());
        tokenizers.put("0*", transacaoLineTokenizer());
        return tokenizers;
    }
    ...
    private LineTokenizer transacaoLineTokenizer() {
        DelimitedLineTokenizer lineTokenizer = new DelimitedLineTokenizer();
        lineTokenizer.setNames("transacao", "descricao", "valor");
